...
# ===========================================================================
HOST = "girish"   # shown as  girish@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Full-Stack + AI/ML Dev, CS Honours '26"),
    ("kv", "Building", "ML-powered web apps, end to end"),
    ("kv", "School", "BSc Computer Science (Hons), 3.74 GPA"),
    ("kv", "Based", "Cambridge, Ontario, Canada"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript"),
    ("kv", "Backend", "FastAPI, Flask, Node, PostgreSQL"),
    ("kv", "AI / ML", "TensorFlow, scikit-learn, MLflow"),
    ("kv", "Cloud", "AWS EC2/S3, Docker, Vercel"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Zonalyze: RF feasibility engine, R2=0.99"),
    ("bul", "ETHOS: 94.91% NASA exoplanet classifier"),
    ("bul", "IT Club President, HackTheBrain Director"),
]
