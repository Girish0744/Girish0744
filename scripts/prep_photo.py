...
# 1. cut out the subject. REMBG_MODEL selects the matting model; default "u2net"
# (best quality, ~176MB one-time download). Set REMBG_MODEL=u2netp for the small
# ~4.7MB model when bandwidth is tight.
...
clahe = cv2.createCLAHE(clipLimit=float(os.environ.get("CLAHE_CLIP", "2.6")), tileGridSize=(8, 8))
