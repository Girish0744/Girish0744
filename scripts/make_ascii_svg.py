...
CONTRAST = 1.15
BRIGHTNESS = 1.0
GAMMA = 1.08          # tuned for Girish's prepped portrait (clipLimit 1.4)
SHARPEN = False
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">girish@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'girish@github:~$ whoami <tspan fill="{INK}">Girish Bhuteja</tspan></text>')
